...
//! exchange cycle through a GripperSync cursor from makeSync().
...
bool closeFastThenGently(Gripper& gripper, GripperCommand& command, Logger& logger)
{
   ...
   // The cursor keeps the place, and hands each status out with the wake
