...
invisible in the generated site's navigation. That's what happened to
DeviceProfile, the units.hpp conversions, and to_string.hpp before they were
each given an \\ingroup.
